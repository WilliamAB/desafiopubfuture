...
public class TipoDespesaRepositoryTest {
	...
	private final String DESCRICAO_1 = "Tipo de despesa Teste 1";
	private final String DESCRICAO_ATUALIZADA_1 = "Tipo de despesa Teste 1 atualizada";

	private static final String DESCRICAO_2 = "Tipo de despesa Teste 2";
	...
	public void testFindById() {
		Optional<TipoDespesaEntity> optional = repository.findById(ID_1);
